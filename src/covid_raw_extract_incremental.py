...
## @type: DataSource
## @args: [database = "covid-raw", table_name = "pg_postgres_covid_raw_ctrl_meta_tbl", transformation_ctx = "DataSource1"]
## @return: DataSource1
## @inputs: []
DataSource1 = glueContext.create_dynamic_frame.from_catalog(database = "covid-raw", table_name = "pg_postgres_covid_raw_ctrl_meta_tbl", transformation_ctx = "DataSource1")
## @type: Join
## @args: [keys2 = ["run_date"], keys1 = ["dateannounced"], transformation_ctx = "Transform0"]
## @return: Transform0
## @inputs: [frame1 = DataSource0, frame2 = DataSource1]
Transform0 = Join.apply(frame1 = DataSource0, frame2 = DataSource1, keys2 = ["run_date"], keys1 = ["dateannounced"], transformation_ctx = "Transform0")
## @type: DataSink
